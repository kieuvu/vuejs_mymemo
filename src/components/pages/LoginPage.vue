          ...
          <div class="bg-white py-8 px-4 shadow-2xl sm:rounded-lg sm:px-10">
            ...
            <form class="space-y-6" @submit.prevent="formSubmit()">
              ...
              <div>
                <button
                  type="submit"
                  class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 active:outline-none active:ring-2 active:ring-offset-2 active:ring-indigo-500"
                >
                  Sign in
                </button>
              </div>
            ...
            <div class="flex items-center justify-center mt-6">
              <div class="text-sm">
                <router-link to="/register" class="font-medium text-indigo-600 hover:text-indigo-500">
                  Can't login? Sign up for a new account.
                </router-link>
              </div>
            </div>
